    ...
    return(
      <nav id="navbar">
          ...
          <div className="navigation-links-container">
            ...
            <div className="navigation-links-container">
              <h4 className="nav-headers">COMING SOON</h4>
              <div id="navigation-links">
                <a><svg className="nav-icons xs" style={{ fill: "#ffb330"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512z"/></svg>Analytics</a>
                <a><svg className="nav-icons xs" style={{ fill: "#665BF7"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512z"/></svg>Marketing</a>
                <a><svg className="nav-icons xs" style={{ fill: "#00D9CB"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512z"/></svg>Trends</a>
              </div>
            </div>
          </div>
